...
void Setup() {
	...
	if (ciclo == 0) {
        ...
        std::cout << "Face count = " << count << "\n";
        
        cout << " 2) operator[]: access individual face\n";
        const Facet& f00 = dodec[0];
        std::cout << "Face 0: " << f00 << "\n\n";

        cout << dodec << "\n\n";

        cout << " 3) center(): compute geometric center of all vertices\n";
        Vector3D ctr0 = dodec.center();
