...
void Setup() {
	...
	if (ciclo == 0) {
        ...
        Dodecahedron d1(0.93, Vector3D(0, 0.001, 0), FaceMode::Pentagons);
        ...
        box_out_3 = box_out_1.refine(1, FacetBox::SubdivisionMode::Midpoint4);

        box_out_0 = box_out_3.refine(2, FacetBox::SubdivisionMode::Midpoint4);

        //box_out_0 = box_out_3.refine(1, FacetBox::SubdivisionMode::Midpoint6);
